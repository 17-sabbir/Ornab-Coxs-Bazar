...
<div class="row">
    <div class="col-xl-10 mx-auto">
        <h6 class="mb-0 text-uppercase">Edit Volunteer Information</h6>
        <hr/>
        ...
        <div class="card">
            <div class="card-body">
                <div class="p-4 border rounded">
                    <form action="{{ route('admin.volunteer_info.update', $info->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <a href="{{ route('admin.volunteer_info.index') }}" class="btn btn-secondary px-5 ms-2">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
