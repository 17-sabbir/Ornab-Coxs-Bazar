                ...
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('slider.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" name="order" class="form-control @error('order') is-invalid @enderror" id="order" value="{{ old('order') }}" placeholder="Enter display order (unique, ascending)" min="1">
                            @error('order')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
