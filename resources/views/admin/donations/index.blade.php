...
<div class="row">
    <div class="col-md-12 mx-auto">
        ...
        <div class="mb-3 d-flex flex-wrap gap-2">
            <a href="{{ route('admin.payment_methods.index') }}" class="btn btn-outline-primary btn-sm rounded-pill px-3">
                <i class="bx bx-credit-card me-1"></i> Payment Methods
            </a>
            <a href="{{ route('admin.payment_methods.add') }}" class="btn btn-outline-primary btn-sm rounded-pill px-3">
                <i class="bx bx-plus-circle me-1"></i> Add Payment Method
            </a>
            <a href="{{ route('admin.donation_campaigns.index') }}" class="btn btn-outline-primary btn-sm rounded-pill px-3">
                <i class="bx bx-donate-heart me-1"></i> Donation Campaigns
            </a>
        </div>
        <div class="card">
