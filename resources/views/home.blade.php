    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center pt-3">
                ...
                <h2 class="fw-bold text-dark mt-3 mb-0" style="letter-spacing: -0.5px;">Focus Area</h2>
            </div>
        </div>
...
<div class="uerd-sponsor-wrap">
    <style>
        ...
        .uerd-sponsor-btn {
            background: #fff; color: #0d9488; border: none; font-weight: 600;
        }
        .uerd-sponsor-btn:hover { background: #e6f7f2; color: #0d5f49; }
