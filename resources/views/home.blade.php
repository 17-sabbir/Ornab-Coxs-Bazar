...
<div class="ornab-soft-section ornab-section ornab-section-tight-top ornab-section-tight-bottom">
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center pt-3">
            <a href="{{ route('ongoing.project') }}" class="btn btn-primary ornab-btn-pill d-inline-flex align-items-center gap-2" style="border-width: 2px;">
...
<div class="ornab-soft-section ornab-section ornab-section-tight-top">
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center pt-4">
            <a href="{{ route('latest.news.all') }}" class="btn btn-primary ornab-btn-pill d-inline-flex align-items-center gap-2" style="border-width: 2px;">
