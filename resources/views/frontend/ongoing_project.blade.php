...
<div class="container py-5">
    <div class="row">
        <div class="col-12 text-center mb-5">
            <h2 class="display-5 fw-bold uerd-page-title">Ongoing Projects</h2>
            <p class="lead uerd-page-subtitle">Our current active initiatives making a difference</p>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow-sm border-0 uerd-project-card" style="border-top: 4px solid var(--brand-green);">
                ...
                <div style="height: 220px; overflow: hidden; position: relative;">
                    ...
                    @endif
                    <span class="position-absolute top-0 end-0 m-3 badge uerd-status-ongoing">Ongoing</span>
                </div>
        ...
        <div class="col-12 text-center py-5">
            ...
            <h4 class="uerd-body-muted">No ongoing projects at the moment</h4>
        </div>
        @endforelse
    </div>
