...
<div class="container py-5">
    <div class="row">
        <div class="col-12 text-center mb-5">
            <h2 class="display-5 fw-bold text-danger">Ongoing Projects</h2>
            <p class="lead text-secondary">Our current active initiatives making a difference</p>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow-sm border-0 border-top border-4 border-success">
                ...
                <div style="height: 220px; overflow: hidden; position: relative;">
                    ...
                    @endif
                    <span class="position-absolute top-0 end-0 m-3 badge bg-success">Ongoing</span>
                </div>
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('ongoing.project.view', $data->id) }}" class="btn btn-outline-success w-100 mt-auto rounded-pill">
        ...
        <div class="col-12 text-center py-5">
            ...
            <h4 class="text-secondary">No ongoing projects at the moment</h4>
        </div>
        @endforelse
    </div>
