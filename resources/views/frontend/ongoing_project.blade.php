...
<div class="container py-5">
    ...
    <div class="row g-4">
                ...
                <div style="height: 220px; overflow: hidden; position: relative;">
                    ...
                    @else
                        <div class="w-100 h-100 bg-light d-flex align-items-center justify-content-center">
                            <i class="fa-regular fa-folder-open fa-3x ornab-body-muted" style="opacity: 0.25;"></i>
                        </div>
                    @endif
                    <span class="position-absolute top-0 end-0 m-3 badge ornab-status-ongoing">Ongoing</span>
                </div>

                <div class="card-body d-flex flex-column">
                    <h5 class="card-title fw-bold ornab-page-title mb-3" style="min-height: 48px;">{{Str::limit($data->project_name, 60)}}</h5>
                    
                    <h6 class="ornab-objectives fw-bold pb-2 mb-3" style="font-size: 0.9rem;">Objectives</h6>
                    ...
                    <a href="{{ route('ongoing.project.view', $data->id) }}" class="ornab-read-more w-100 mt-auto rounded-pill justify-content-center">
        ...
        <div class="col-12 text-center py-5">
            <i class="fa-regular fa-folder-open fa-4x ornab-body-muted" style="opacity: 0.25; margin-bottom: 1rem;"></i>
            <h4 class="ornab-body-muted">No ongoing projects at the moment</h4>
        </div>
        @endforelse
    </div>

    @if(method_exists($project, 'links'))
