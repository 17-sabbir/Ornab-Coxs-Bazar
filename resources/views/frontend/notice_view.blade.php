...
.uerd-back-btn:hover { background: #0f377a; color: #fff; }
  ...
  <section class="breadcrumbs">
    <div class="container">
      ...
      <h2 class="uerd-page-title">Notice</h2>
    </div>
  </section>
  <!-- End Breadcrumbs -->
    ...
    <div class="container bg-white py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-8 text-left">
                <h2 class="text-left uerd-page-title">{{ $notice->title }}</h2>
            ...
            <div class="py-3">
                <a href="{{ route('notices.all') }}" class="btn uerd-back-btn"> <i class="fa fa-angle-left" aria-hidden="true"></i> Back to Notices </a>
            </div>
        </div>
      </div>
