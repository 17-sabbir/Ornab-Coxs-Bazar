    ...
    <div class="container" style="margin-top: -45px;">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                @if($statement->file_path)
                                    <a href="{{ asset('storage/'.$statement->file_path) }}" target="_blank" class="btn btn-download w-100">
        ...
        @else
            <div class="text-center py-5 bg-white rounded-4 shadow-sm">
                ...
                <h3 class="mt-3">No Statements Yet</h3>
                <p class="text-muted">Financial statements will be published here soon.</p>
            </div>
        @endif
    </div>
</section>
