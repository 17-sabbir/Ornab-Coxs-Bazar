...
<div class="container pt-4 pb-3 text-center">
    <h1 class="fw-bold mb-2 ornab-page-title" style="font-size: 2.2rem; font-family: var(--font-heading);">
        Career with Ornab Cox's Bazar
    </h1>
    <p class="mx-auto mt-2 ornab-body-text" style="max-width: 600px; font-size: 0.95rem; line-height: 1.7;">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                <div class="pe-lg-4">
                    <!-- About Us (Dynamic) -->
                    <div class="mb-4">
                        <h3 class="fw-bold mb-3 ornab-page-title" style="font-size: 1.3rem; border-left: 4px solid var(--brand-coral); padding-left: 12px;">
                            About Us
                        </h3>
                        <div class="ornab-body-text" style="line-height: 1.85; font-size: 0.95rem; text-align: justify;">
            ...
            <div class="col-lg-5">
                ...
                <!-- Available Downloads -->
                <h4 class="fw-bold mb-3 ornab-page-title" style="font-size: 1.1rem;">Available Downloads</h4>
                <div class="d-flex flex-column gap-3">
                    @foreach ($career as $data)
                        <a href="{{ asset('images/invoked/'.$data->file) }}" target="_blank" class="text-decoration-none">
                             <div class="card border-0 shadow-sm p-3 d-flex flex-row align-items-center bg-white ornab-project-card" style="border-radius: 12px; transition: all 0.3s ease; border-left: 4px solid var(--brand-teal) !important;">
                                 ...
                                 <div class="flex-grow-1">
                                     <h6 class="fw-bold mb-1 ornab-page-title" style="font-size: 0.9rem;">{{ $data->name }}</h6>
                                     <small class="ornab-body-text" style="font-size: 0.8rem;">PDF Document</small>
                                 </div>
